...
let s:style = get(g:, 'ayucolor', 'light')
...
let s:palette.bg        = {'dark': "#0F1419",  'light': "#faf4ed",  'mirage': "#212733"}
...
let s:palette.error     = {'dark': "#FF3333",  'light': "#faf4ed",  'mirage': "#FF3333"}
let s:palette.accent    = {'dark': "#F29718",  'light': "#FF6A00",  'mirage': "#FFCC66"}
let s:palette.panel     = {'dark': "#14191F",  'light': "#faf4ed",  'mirage': "#272D38"}
